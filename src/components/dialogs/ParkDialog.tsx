...
const HOARenderer = lazy(() => import('../audio/HoaRenderer'));

function ParkDialog({ setIsOpen, isOpen, parkName, parkDistance, userOrientation }) {
...
export default memo(ParkDialog)