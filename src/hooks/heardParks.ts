 ...
 * reduce-visuals preference: the map markers and the warmth layer read it,
 * and a provider would have to wrap the whole tree to reach the layers.
 */
